    ...
    <div className="flex items-center justify-between px-2 py-1.5 bg-black">
      <div className="flex flex-col">
        <div className="flex items-center gap-1.5">
          ...
          <button type="button" aria-label={t('trade.adjustLeverage')} className="flex items-center gap-1.5 cursor-pointer" onClick={() => haptic.light()}>
            <span className="bg-zinc-800 text-zinc-300 text-[10px] font-medium px-1.5 py-0.5 rounded">{leverage}x</span>
            <ChevronDown size={14} className="text-zinc-500" />
          </button>
        </div>
        <span className="text-zinc-300 text-sm font-medium">-5.21%</span>
      </div>
