...
BOT_MEDIA_SLOTS: list[dict] = [
    ...
    },
    {
        "key": "trading_main",
        "title": "Trading",
        "description": "Показывается над текстом раздела «Trading» при нажатии кнопки «Trading» в главном меню.",
    },
    {
        "key": "education_main",
        "title": "Обучение",
        "description": "Показывается над текстом раздела «Обучение» при нажатии кнопки «Обучение» в главном меню.",
    },
]
